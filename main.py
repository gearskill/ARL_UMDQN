...
from CustomEnvironments.SIMPLE_4x4_GridWorld import SimpleGridWorld
...
environments = ['SimpleGridWorld', 'StochasticGridWorld', 'CartPole-v1', 'Acrobot-v1', # changed cartpole from v0 to v1
...
# Es funktionieren: StochasticGridWorld, CartPole-v1, Acrobot-v1 (braucht ewig fuer eine episode???),
                  # MountainCar-v0 (braucht sehr lange),
